...
export default function LigaInternacional() {
  ...
  const leagues = [
    {
      ...
      logo: "/images/image-removebg-preview (2).png",
      colors: "bg-purple-800"
    },
    {
      name: "Frauen-Bundesliga",
      logo: "/images/image-removebg-preview (3).png",
      colors: "bg-purple-800"
    },
    {
      name: "Liga das Campeãs Feminina",
      logo: "/images/image-removebg-preview (4).png",
      colors: "bg-purple-800"
    },
    {
      name: "NWSL",
      logo: "/images/image-removebg-preview (5).png",
      colors: "bg-purple-800"
    },
    {
      name: "Serie A Tim",
      logo: "/images/image-removebg-preview (6).png",
      colors: "bg-purple-800"
    }
  ];
